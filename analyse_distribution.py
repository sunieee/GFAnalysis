...
50% Quantile: {round(median, 3)}"""
    ...
    # 保存分布图
    plt.savefig(f"out/log/{column_name}_distribution.png")
    print(f"save distribution to out/log/{column_name}_distribution.png")
    # plt.show()

# 使用
analyze_csv(f'out/papers', 'isKeyPaper')
analyze_csv(f'out/edge_proba.csv', 'proba')
